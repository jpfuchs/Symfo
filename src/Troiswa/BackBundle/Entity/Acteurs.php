...
class Acteurs
{
     ...
     * Add LiaisonFilms
     *
     * @param \Troiswa\BackBundle\Entity\Film $liaisonFilms
     * @return Acteurs
     */
    public function addLiaisonFilm(\Troiswa\BackBundle\Entity\Film $liaisonFilms)
    {
     ...
     * @param \Troiswa\BackBundle\Entity\Film $liaisonFilms
     */
    public function removeLiaisonFilm(\Troiswa\BackBundle\Entity\Film $liaisonFilms)
    {
